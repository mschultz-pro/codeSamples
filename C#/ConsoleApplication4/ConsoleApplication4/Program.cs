    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                {
                    menu();
                    string choice = Console.ReadLine(); Ln(); br();
                    string name;
                    int aNumber = 1;
                    double iBalance;
                        ...
                        case "c":
                            {
                                ...
                                name = Console.ReadLine(); Ln();

                                Console.Write("Enter an initial balance for the account: ");
                                iBalance = Convert.ToDouble(Console.ReadLine()); Ln();

                                Console.Write("Enter a fee to be changed per transaction: ");
                                fee = Convert.ToDouble(Console.ReadLine()); Ln();

                                CheckingAccount thing = new CheckingAccount(iBalance, name, aNumber, fee);
                                aNumber = aNumber + 1;
                        ...
                        case "s":
                            {
                                ...
                                Console.Write("Enter an interest rate for the account: ");
                                rate = Convert.ToDouble(Console.ReadLine()); Ln();

                                SavingsAccount thing = new SavingsAccount(iBalance, name, aNumber, rate);
                                break;
                            }
                        case "q":
                            {
